...
class Lamina1 extends JPanel implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == nuevaPartidaButton) {
            ...
            frame.getContentPane().add(new Lamina2(frame));
            frame.revalidate();
            frame.repaint();
    ...
    class Lamina2 extends JPanel implements ActionListener {
        ...
        public Lamina2(Marco frame) {
            ...
            JScrollPane scrollPane = new JScrollPane(menuLabel1);
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() instanceof JButton) {
                ...
                if (button.getText().equals("Salir")) {
                    frame.getContentPane().removeAll();
                    frame.getContentPane().add(new Lamina1(frame));
                    frame.revalidate();
                    frame.repaint();
                }
            }
